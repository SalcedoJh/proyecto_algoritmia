...
public class FMConsultarCelular extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FMConsultarCelular frame = new FMConsultarCelular();
	...
	public FMConsultarCelular() {
		...
		comboBox.setBounds(162, 9, 155, 22);
